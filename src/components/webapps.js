        ...
        return (
            <React.Fragment>
                ...
                <div className="itm-portafolio">
                    ...
                    <p>Es una página web reactiva (SPA) tiene como objetivo mostrar el portafolio de la empresa con sus servicios y una sección para que los clientes se puedan poner en contacto con la empresa.</p>
